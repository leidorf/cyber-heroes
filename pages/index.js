...
export default function Home() {
  const links = [
    ...
    { href: "/about", text: "About", color: "text-green-500 border-green-500 dark:text-green-600 dark:border-green-600" },
    { href: "/contact", text: "Contact", color: "text-purple-500 border-purple-500 dark:text-purple-700 dark:border-purple-700" },
  ];
        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-16rem)]">
          <div className="w-full max-w-lg text-center">
            <div className="border-2 rounded-lg border-blue-500 dark:border-blue-700 grinched p-6 shadow-lg">
              <p className="text-5xl lg:text-6xl text-blue-500 dark:text-blue-700 mb-8">Cyber Heroes</p>
